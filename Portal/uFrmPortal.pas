...
function TFrmPortal.VerModuloAberto: string;
...
Procedure TFrmPortal.ExecutaApp(Nome,NomeExec:string);
...
procedure TFrmPortal.actArmazemExecute(Sender: TObject);
begin
  //
...
procedure TFrmPortal.ClientSocketDisconnect(Sender: TObject;
...
procedure TFrmPortal.ClientSocketError(Sender: TObject; Socket: TCustomWinSocket;
  ErrorEvent: TErrorEvent; var ErrorCode: Integer);
begin
  //
...
procedure TFrmPortal.ClientSocketRead(Sender: TObject; Socket: TCustomWinSocket);
begin
  //
  Ok := False;
...
procedure TFrmPortal.FechaModulosAbertos;
...
procedure TFrmPortal.FormShow(Sender: TObject);
Var
  ip: String;
begin
  //
