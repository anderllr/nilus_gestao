inherited FrmPesOperacao: TFrmPesOperacao
  Caption = 'Pesquisa de Opera'#231#245'es'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited cdsGrid: TClientDataSet
    CommandText = 
      'SELECT M.idEmpresa, M.idCadEmpresa, M.idOperacao, dtOperacao, vl' +
      'Produto  FROM MaquinaOperacao M INNER JOIN vcadEmpresaFiscal cad' +
      '  ON M.idEmpresa = cad.idEmpresa AND M.idCadEmpresa = cad.idCadE' +
      'mpresa LEFT JOIN MaquinaOperacaoProd MI ON MI.idEmpresa = M.idEm' +
      'presa AND MI.idCadEmpresa = M.idCadEmpresa AND MI.idOperacao = M' +
      '.idOperacao'
    ...
    object cdsGrididOperacao: TIntegerField
      FieldName = 'idOperacao'
      Required = True
    end
    object cdsGriddtOperacao: TSQLTimeStampField
      FieldName = 'dtOperacao'
      Required = True
    end
