inherited FrmPesContratoVenda: TFrmPesContratoVenda
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object UniQryPadraostPrevisao: TStringField
  ...
  inherited sdsGrid: TSQLDataSet
    CommandText = 
      ...
      'breviada,  idContratoVenda, dtEmissao, vlContratoVenda, stContra' +
      'toVenda, con.qtProduto,  con.vlProduto, con.qtArrobas, con.qtSac' +
      'as, vlIcms, vlImposto, vlOutrosImp, vlIcmsFrete,  vlFrete, vlCom' +
      'issao, CONVERT(MONEY, SUM(con.vlProduto*con.qtProduto)) vlTotalP' +
      'rodutos,s.descSafra FROM ContratoVenda con  INNER JOIN vCadClien' +
      'teContabil cad ON con.idCliente = cad.idCliente INNER JOIN Safra' +
      ' s  ON con.idSafra = s.idSafra AND con.idEmpresa = s.idEmpresa  ' +
      'WHERE 1=1  GROUP BY con.idEmpresa, con.idCadEmpresa, con.idClien' +
      'te, cad.descAbreviada, idContratoVenda, dtEmissao, vlContratoVen' +
      'da, stContratoVenda, con.qtProduto,  con.vlProduto, con.qtArroba' +
      's, con.qtSacas, vlIcms, vlImposto, vlOutrosImp, vlIcmsFrete,  vl' +
      'Frete, vlComissao, s.descSafra'
  end
