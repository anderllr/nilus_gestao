...
type
  TFrmRelLocalEmbarque = class(TFrmPadraoRelEmpresa)
...
var
  FrmRelLocalEmbarque: TFrmRelLocalEmbarque;
...
procedure TFrmRelLocalEmbarque.actGerarExecute(Sender: TObject);
var
...
procedure TFrmRelLocalEmbarque.cdsPadraoAfterInsert(DataSet: TDataSet);
begin
  inherited;
  cdsPadraoRomAConfirmar.AsString := 'S';
end;

procedure TFrmRelLocalEmbarque.DBEidContratoVendaKeyDown(Sender: TObject;
...
procedure TFrmRelLocalEmbarque.DBEidEmpresaExit(Sender: TObject);
begin
  inherited;
...
procedure TFrmRelLocalEmbarque.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  inherited;
  FrmRelLocalEmbarque := nil;
end;

procedure TFrmRelLocalEmbarque.FormCreate(Sender: TObject);
begin
  inherited;
  fiscal := True;
...
procedure TFrmRelLocalEmbarque.FormShow(Sender: TObject);
begin
  inherited;
  cdsPadraoidEmpresa.AsInteger := cdsEmpresaidEmpresa.AsInteger;
  cdsPadraoidCadEmpresa.AsInteger := cdsEmpresaidCadEmpresa.AsInteger;
...
procedure TFrmRelLocalEmbarque.frxRelAfterPrint(
