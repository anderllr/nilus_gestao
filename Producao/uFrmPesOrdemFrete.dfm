inherited FrmPesOrdemFrete: TFrmPesOrdemFrete
  Caption = 'Pesquisa de Ordens de Frete'
  ClientHeight = 455
  ClientWidth = 736
  Icon.Data = {
  ...
  inherited PanBotoes: TCPanelGradient
    ...
    object CLabel2: TCLabel [7]
      Left = 241
      Top = 9
      Width = 67
      Height = 13
      Alignment = taRightJustify
      Caption = 'Nota Fiscal de'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object cdsPadraoidOrdemIni: TIntegerField
      FieldName = 'idOrdemIni'
    end
    object cdsPadraoidOrdemFim: TIntegerField
      FieldName = 'idOrdemFim'
    end
  ...
  inherited cdsGrid: TClientDataSet
    CommandText = 
      'SELECT o.idEmpresa, o.idCadEmpresa, o.idOrdemFrete, onf.idNf, o.' +
      'dtEmissao, o.vlFreteTotal FROM OrdemFrete o INNER JOIN OrdemFret' +
      'eNf onf ON o.idEmpresa = onf.idEmpresa AND o.idCadEmpresa = onf.' +
      'idCadEmpresa AND o.idOrdemFrete = onf.idOrdemFrete WHERE 1=2'
    Left = 280
    Top = 336
    ...
    object cdsGrididOrdemFrete: TIntegerField
      FieldName = 'idOrdemFrete'
      Required = True
    end
    ...
    object cdsGridvlFreteTotal: TFMTBCDField
      FieldName = 'vlFreteTotal'
      Required = True
      Precision = 19
      Size = 4
  ...
  inherited sdsGrid: TSQLDataSet
    CommandText = 
      'SELECT o.idEmpresa, o.idCadEmpresa, o.idOrdemFrete, o.idNf, o.dt' +
      'Emissao, o.vlFreteTotal, cad.descAbreviada FROM OrdemFrete o INN' +
      'ER JOIN OrdemFreteItem oi ON o.idEmpresa = oi.idEmpresa AND o.id' +
      'CadEmpresa = oi.idCadEmpresa AND o.idOrdemFrete = oi.idOrdemFret' +
      'e INNER JOIN vCadFornecedorContabil cad ON oi.idFornecedor = cad' +
      '.idFornecedor WHERE 1=2'
    Left = 136
    Top = 336
  end
