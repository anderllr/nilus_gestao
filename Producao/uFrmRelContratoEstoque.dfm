inherited FrmRelContratoEstoque: TFrmRelContratoEstoque
  Caption = 'Relat'#243'rio de Contrato de Estoque'
  ClientHeight = 172
  ClientWidth = 560
  ExplicitWidth = 576
  ExplicitHeight = 211
  ...
  object CGroupBox1: TCGroupBox [9]
    ...
    Height = 103
    Align = alClient
    Caption = 'Dados para Relat'#243'rio'
    Color = 15201011
    ...
    object DBEdtContratoIni: TCDBEdit
      Left = 59
      Top = 68
      Width = 80
      Height = 19
  ...
  inherited cdsRelatorio: TClientDataSet
    CommandText = 'EXEC spRelContratoEstoque 1, 1, 1, 1, '#39'09/05/2015'#39
    Left = 568
    Top = 32
    object UniQryRelatorioidEmpresa: TIntegerField
      FieldName = 'idEmpresa'
    end
    object UniSPRelatorioidCadEmpresa: TSmallintField
      FieldName = 'idCadEmpresa'
    end
    object UniQryRelatorioidFornecedor: TIntegerField
      FieldName = 'idFornecedor'
    end
    object UniSPRelatorioidCadFornecedor: TSmallintField
      FieldName = 'idCadFornecedor'
    end
    object UniQryRelatorioidContratoCompra: TStringField
      FieldName = 'idContratoCompra'
      Size = 30
    end
    object UniQryRelatoriodescFornecedor: TStringField
      FieldName = 'descFornecedor'
      Size = 60
    end
    object cdsRelatorioqtAEmbarcar: TFMTBCDField
      FieldName = 'qtAEmbarcar'
      Precision = 18
      Size = 3
    end
    object UniQryRelatoriodescLocalEmbarque: TStringField
      FieldName = 'descLocalEmbarque'
      Size = 60
    end
    object UniQryRelatoriodescCidade: TStringField
      FieldName = 'descCidade'
      Size = 50
    end
    object cdsRelatoriodtPagamento: TSQLTimeStampField
      FieldName = 'dtPagamento'
    end
    object cdsRelatoriodtVencimento: TSQLTimeStampField
      FieldName = 'dtVencimento'
    end
    object cdsRelatoriovlSaca: TFMTBCDField
      FieldName = 'vlSaca'
      Precision = 19
      Size = 4
    end
    object cdsRelatoriovlAEmbarcar: TFMTBCDField
      FieldName = 'vlAEmbarcar'
      Precision = 19
      Size = 4
    end
    object UniQryRelatorioAFixar: TStringField
      FieldName = 'AFixar'
      FixedChar = True
      Size = 1
    end
    object UniQryRelatoriodescGrupo: TStringField
      FieldName = 'descGrupo'
      Size = 150
    end
    object cdsRelatorioqtSacas: TFMTBCDField
      FieldName = 'qtSacas'
      Precision = 15
      Size = 3
    end
    object UniQryRelatoriostTituloPag: TStringField
  ...
  inherited frxDataset: TfrxDBDataset
    FieldAliases.Strings = (
      ...
      'qtAEmbarcar=qtAEmbarcar'
      'descLocalEmbarque=descLocalEmbarque'
      'descCidade=descCidade'
      'dtPagamento=dtPagamento'
      'dtVencimento=dtVencimento'
      'vlSaca=vlSaca'
      'vlAEmbarcar=vlAEmbarcar'
      'AFixar=AFixar'
      'descGrupo=descGrupo'
      'qtSacas=qtSacas'
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object UniQryPadraodtIni: TDateField
      FieldName = 'dtIni'
    end
  end
  object FrxRel: TfrxReport
    ...
    ReportOptions.LastChange = 42187.905291736110000000
    ...
    object Page1: TfrxReportPage
      ...
      object Footer1: TfrxFooter
        ...
        object Memo16: TfrxMemoView
          ...
          HideZeros = True
          Memo.UTF8W = (
            '[SUM(<frxDataset."qtAEmbarcar">,DetailData1)]')
          ParentFont = False
          WordWrap = False
        end
        object Memo18: TfrxMemoView
          ...
          HideZeros = True
          Memo.UTF8W = (
            '[SUM(<frxDataset."vlAEmbarcar">,DetailData1)]')
          ParentFont = False
          WordWrap = False
        end
      end
