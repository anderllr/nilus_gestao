inherited FrmTransfContratoCompra: TFrmTransfContratoCompra
  BorderIcons = [biSystemMenu]
  Caption = 'Transfer'#234'ncia entre Contratos de Compra'
  ClientHeight = 521
  ClientWidth = 945
  ...
  inherited PanBotoes: TCPanelGradient
    ...
    object DBEidFornecedorDes: TCDBEdit
      Left = 589
      Top = 32
      Width = 61
      Height = 19
      BevelKind = bkTile
      BorderStyle = bsNone
      DataField = 'idFornecedorDes'
      DataSource = dsPadrao
      TabOrder = 11
      OnKeyDown = DBEidFornecedorDesKeyDown
      OnKeyPress = DBEidFornecedorDesKeyPress
      DecimalControl = True
      KeyMode = kmNormal
    end
    object DBEidCadFornecedorDes: TCDBEdit
      Left = 656
      Top = 32
      Width = 28
      Height = 19
    ...
    object DBEidContratoCompraDes: TCDBEdit
      Left = 589
      Top = 57
      Width = 104
      Height = 19
      BevelKind = bkTile
      BorderStyle = bsNone
      DataField = 'idContratoCompraDes'
      DataSource = dsPadrao
      TabOrder = 14
      OnKeyDown = DBEidContratoCompraDesKeyDown
      DecimalControl = True
      KeyMode = kmUSUpper
    end
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object cdsPadraoidCadFornecedor: TStringField
    ...
    object cdsPadraoidFornecedorDes: TIntegerField
      FieldName = 'idFornecedorDes'
    end
    object cdsPadraoidCadFornecedorDes: TIntegerField
      FieldName = 'idCadFornecedorDes'
    end
    object cdsPadraoidContratoCompraDes: TStringField
      FieldName = 'idContratoCompraDes'
      Size = 30
    end
  end
