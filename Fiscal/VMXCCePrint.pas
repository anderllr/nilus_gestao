unit VMXCCePrint;
interface
uses Windows, RpDefine, RpBase, RpSystem, Graphics, SysUtils, Classes, RpRenderPDF,     RpDevice, MaskUtils, Forms;
...
begin
   ...
   impDefTamFon(16);
   impCon(105,17,'CARTA DE CORREÇÃO ELETRÔNICA',al_center,true);
   impDefTamFon(10);
   impCon(105,22,'Este impresso não tem valor fiscal e é uma simples representação da CCe indicada abaixo.',al_center,false);
