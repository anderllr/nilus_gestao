inherited FrmRelContabilXFinan: TFrmRelContabilXFinan
  Caption = 'Listagem de Gerencial n'#227'o Relacionado no Contabil'
  ClientHeight = 300
  ClientWidth = 733
  ExplicitWidth = 749
  ExplicitHeight = 338
  ...
  inherited cdsRelatorio: TClientDataSet
    CommandText = 
      'SELECT * FROM vGerencial WHERE idGerencial NOT IN (SELECT idGere' +
      'ncial FROM ContRelaciona) ORDER BY idGerencial'
  end
  ...
  object frxRel: TfrxReport
    ...
    ReportOptions.LastChange = 41022.671523356500000000
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo7: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Gerenciais n'#227'o Relacionados')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object GHRelatorio: TfrxGroupHeader
        ...
        object DBMTitdescGrupo: TfrxMemoView
          Left = 205.787447950000000000
          Top = 3.779527559055112000
          Width = 274.252010000000000000
          Height = 15.118110240000000000
          ShowHint = False
          AutoWidth = True
          DisplayFormat.DecimalSeparator = ','
      ...
      object Band4: TfrxMasterData
        ...
        object DBMdescGrupo: TfrxMemoView
          Left = 205.411096710000000000
          Top = 0.755905511811022300
          Width = 304.629994490000000000
          Height = 15.118110240000000000
          ShowHint = False
          DataSet = frxDataset
          DataSetName = 'frxDataset'
