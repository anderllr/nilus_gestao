unit uFrmPadraoPesqEmpFiscalPivot;
...
uses
  ...
  CFind, System.Actions, uFrmPadraoPesquisaPivot, cxGraphics, cxControls,
  cxLookAndFeels, cxLookAndFeelPainters, cxClasses, cxCustomData, cxStyles,
  cxEdit, cxCustomPivotGrid, cxDBPivotGrid, System.ImageList;

type
  TFrmPadraoPesqEmpFiscalPivot = class(TFrmPadraoPesquisaPivot)
...
var
  FrmPadraoPesqEmpFiscalPivot: TFrmPadraoPesqEmpFiscalPivot;
...
procedure TFrmPadraoPesqEmpFiscalPivot.cdsEmpresaidEmpresaValidate(Sender: TField);
begin
  inherited;
...
procedure TFrmPadraoPesqEmpFiscalPivot.ConfigLookEmpresa;
begin
...
procedure TFrmPadraoPesqEmpFiscalPivot.DBEidEmpresaEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrmPadraoPesqEmpFiscalPivot.DBEidEmpresaExit(Sender: TObject);
begin
  inherited;
...
procedure TFrmPadraoPesqEmpFiscalPivot.DBEidEmpresaKeyDown(Sender: TObject;
...
procedure TFrmPadraoPesqEmpFiscalPivot.FormCreate(Sender: TObject);
begin
  ConfigLookEmpresa;
  inherited;
end;

procedure TFrmPadraoPesqEmpFiscalPivot.FormShow(Sender: TObject);
begin
  inherited;
  with (Formulario.FindComponent('cdsEmpresa') as TClientDataSet) do
  begin
