inherited FrmPesCotacao: TFrmPesCotacao
  Caption = 'Pesquisa de Cota'#231#245'es'
  ClientHeight = 506
  ClientWidth = 736
  Icon.Data = {
  ...
  inherited PanTopo: TCPanelGradient
    ...
    object PanFornecedor: TCPanelGradient
      ...
      object DBEidCotacaoFim: TCDBEdit
        Left = 558
        Top = 35
        Width = 70
        Height = 19
      ...
      object DBEidCotacaoIni: TCDBEdit
        Left = 460
        Top = 35
        Width = 70
        Height = 19
  ...
  inherited cdsGrid: TClientDataSet
    CommandText = 
      'SELECT idEmpresa, idCotacao, dtCotacao, obsCotacao, stCotacao FR' +
      'OM Cotacao WHERE 1=2'
    Left = 280
    Top = 336
    ...
    object cdsGrididCotacao: TIntegerField
      FieldName = 'idCotacao'
      Required = True
    end
    object cdsGriddtCotacao: TSQLTimeStampField
      FieldName = 'dtCotacao'
      Required = True
    end
    object cdsGridobsCotacao: TStringField
      FieldName = 'obsCotacao'
      Size = 250
    end
    object cdsGridstCotacao: TStringField
      FieldName = 'stCotacao'
      Required = True
      Size = 15
    end
