inherited FrmPesRequisicao: TFrmPesRequisicao
  Caption = 'Pesquisa de Requisi'#231#245'es'
  ClientHeight = 506
  ClientWidth = 736
  Icon.Data = {
  ...
  inherited PanBotoes: TCPanelGradient
    ...
    object CGroupBox1: TCGroupBox
      ...
      Height = 34
      TabOrder = 10
      object DBCKstFechada: TCDBCheckBox
        Left = 197
        Top = 11
        Width = 73
        Height = 17
    ...
    object DBEidRequisicaoFim: TCDBEdit
      Left = 558
      Top = 35
      Width = 70
      Height = 19
    ...
    object DBEidRequisicaoIni: TCDBEdit
      Left = 460
      Top = 35
      Width = 70
      Height = 19
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object cdsPadraoidRequisicaoIni: TIntegerField
      FieldName = 'idRequisicaoIni'
    end
    object cdsPadraoidRequisicaoFim: TIntegerField
      FieldName = 'idRequisicaoFim'
    end
    ...
    object cdsPadraostFechada: TStringField
      FieldName = 'stFechada'
      Size = 1
    end
  ...
  inherited cdsGrid: TClientDataSet
    CommandText = 
      'SELECT idEmpresa, idCadEmpresa, idRequisicao, dtRequisicao, obsR' +
      'equisicao, stRequisicao FROM Requisicao WHERE 1=2'
    Left = 280
    Top = 336
    ...
    object cdsGriddtRequisicao: TSQLTimeStampField
      FieldName = 'dtRequisicao'
      Required = True
    end
    object cdsGridobsRequisicao: TStringField
      FieldName = 'obsRequisicao'
      Size = 250
    end
    object cdsGridstRequisicao: TStringField
      FieldName = 'stRequisicao'
      Required = True
      Size = 15
    end
