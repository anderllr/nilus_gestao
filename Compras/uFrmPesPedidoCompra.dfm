inherited FrmPesPedidoCompra: TFrmPesPedidoCompra
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object cdsPadraostEncerrada: TStringField
      FieldName = 'stEncerrada'
    end
    ...
    object cdsPadraonrOriginalIni: TStringField
      FieldName = 'nrOriginalIni'
    end
    object cdsPadraonrOriginalFim: TStringField
  ...
  inherited sdsPadrao: TSQLDataSet
    CommandText = 
      'SELECT p.idEmpresa, p.idCadEmpresa, p.idPedidoCompra, p.dtPedido' +
      ', p.obsPedido, p.stPedido FROM PedidoCompra p LEFT JOIN PedidoCo' +
      'mpraProd pp ON p.idEmpresa = pp.idEmpresa AND p.idCadEmpresa = p' +
      'p.idCadEmpresa  AND p.idPedidoCompra = pp.idPedidoCompra WHERE 1' +
      '=1 AND pp.idProduto = 1 AND p.idEmpresa = 1 AND p.stPedido IN ('#39 +
      'ATIVO'#39','#39'PARCIAL'#39')'
    Left = 136
    Top = 400
  end
