inherited FrmManutencaoFrete: TFrmManutencaoFrete
  Caption = 'Manuten'#231#227'o de Fretes'
  ClientHeight = 494
  ClientWidth = 937
  ExplicitWidth = 953
  ExplicitHeight = 532
  ...
  object PanTopo: TCPanelGradient [5]
    Left = 0
    Top = 0
    Width = 937
    Height = 105
  ...
  object cdsGrid: TClientDataSet
    ...
    CommandText = 'SELECT * FROM tmpContratoFrete WHERE 1=1'
    Params = <>
    ...
    object cdsGrididMotorista: TIntegerField
      FieldName = 'idMotorista'
    end
    ...
    object cdsGridqtPesoBruto: TIntegerField
      FieldName = 'qtPesoBruto'
    end
    ...
    object cdsGridtpContratoFrete: TStringField
      FieldName = 'tpContratoFrete'
      FixedChar = True
      Size = 1
    end
    ...
    object cdsGridfator: TIntegerField
      FieldName = 'fator'
    end
