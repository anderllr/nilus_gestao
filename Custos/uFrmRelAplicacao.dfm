inherited FrmRelAplicacao: TFrmRelAplicacao
  Caption = 'Rela'#231#227'o de Aplica'#231#245'es'
  ClientHeight = 750
  ClientWidth = 1370
  ExplicitTop = -275
  ExplicitWidth = 1386
  ...
  object CGroupBox1: TCGroupBox [12]
    Left = 8
    Top = 34
    Width = 593
    Height = 191
    ...
    object DBEidProduto: TcxPopupEdit
      Left = 77
      Top = 70
      Style.BorderColor = clBtnShadow
      Style.BorderStyle = ebsSingle
  ...
  object DBEsubgrupos: TCDBEdit [14]
    Left = 66
    Top = 351
    Width = 50
    Height = 19
  ...
  object panProduto: TPanel [20]
    ...
    object GridProduto: TcxGrid
      ...
      TabOrder = 0
      LookAndFeel.Kind = lfOffice11
      object DBTableViewProduto: TcxGridDBTableView
        Navigator.Buttons.CustomButtons = <>
        Navigator.Buttons.Delete.Enabled = False
        Navigator.Buttons.Delete.Visible = False
        ...
        object cxGridDBCodProduto: TcxGridDBColumn
          Caption = 'C'#243'digo'
          DataBinding.FieldName = 'idProduto'
          HeaderAlignmentHorz = taRightJustify
          Width = 97
        end
        object cxGridDBNomeProduto: TcxGridDBColumn
      ...
      object cxGridLevel4: TcxGridLevel
        GridView = DBTableViewProduto
      end
    end
    object BtnAplicarProduto: TCBitBtn
      Left = 4
      Top = 183
      Width = 71
      Height = 28
    ...
    object BtnCancelarProduto: TCBitBtn
      Left = 81
      Top = 183
      Width = 76
      Height = 28
    ...
    object BtnLimparProduto: TCBitBtn
      Left = 163
      Top = 183
      Width = 71
      Height = 28
    ...
    object cbCodProduto: TcxCheckBox
      Left = 177
      Top = 7
      TabStop = False
      Caption = 'C'#243'digo'
    ...
    object cbDescProduto: TcxCheckBox
      Left = 241
      Top = 7
      TabStop = False
      Caption = 'Produto'
  ...
  object DBEprodutos: TCDBEdit [21]
    Left = 66
    Top = 395
    Width = 50
    Height = 19
  ...
  inherited cdsRelatorio: TClientDataSet
    CommandText = 
      ' EXEC spRelAplicacao 1, '#39'01/03/2017'#39', '#39'31/03/2017'#39', 0, NULL, NUL' +
      'L, NULL, NULL, '#39'N'#39
    Left = 712
    Top = 96
  end
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object cdsPadraoprodutos: TStringField
      FieldName = 'produtos'
    end
  end
  ...
  object frxRel: TfrxReport
    ...
    ReportOptions.LastChange = 43112.363448194440000000
    ...
    object Page1: TfrxReportPage
      ...
      object Band4: TfrxMasterData
        ...
        object Memo2: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[(<frxDataset."dtAplicacao">)]')
          ParentFont = False
          VAlign = vaBottom
        end
        object Memo26: TfrxMemoView
          Left = 129.614173230000000000
          Top = 3.779527559055120000
        ...
        object Memo25: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[(<frxDataset."idAplicacao">)]')
          ParentFont = False
          VAlign = vaBottom
        end
        object Memo12: TfrxMemoView
          Left = 496.606299210000000000
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[(<frxDataset."qtAplicacao">)]')
          ParentFont = False
          VAlign = vaBottom
        end
        object Memo4: TfrxMemoView
          Left = 563.125984250000000000
          Top = 3.779527559055120000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[(<frxDataset."idResultado">)]')
          ParentFont = False
          VAlign = vaBottom
        end
        object Memo34: TfrxMemoView
          Left = 608.102362200000000000
          Top = 3.779527559055120000
      ...
      object GroupHeader2: TfrxGroupHeader
        ...
        object Memo8: TfrxMemoView
          Left = 563.236200950000000000
          Top = 24.566934020000000000
        ...
        object Memo11: TfrxMemoView
          Left = 608.252337090000000000
          Top = 24.566934020000000000
          Width = 95.401670000000000000
          Height = 15.118110240000000000
          AutoWidth = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
      ...
      object GroupFooter2: TfrxGroupFooter
        ...
        object Memo40: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Total de [(<frxDataset."idResultado">)] - [(<frxDataset."descRes' +
              'ultado">)]')
          ParentFont = False
          VAlign = vaCenter
          Formats = <
  ...
  object cdsProduto: TClientDataSet
    Aggregates = <>
    CommandText = 'SELECT * FROM Produto WHERE stProduto = '#39'ATIVO'#39
    Params = <>
