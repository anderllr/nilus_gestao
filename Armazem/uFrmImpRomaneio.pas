...
type
  TFrmImpRomaneio = class(TFrmPadraoImpressao)
...
procedure TFrmImpRomaneio.actImprimirExecute(Sender: TObject);
begin
  inherited;
...
procedure TFrmImpRomaneio.FormCreate(Sender: TObject);
begin
  inherited;
