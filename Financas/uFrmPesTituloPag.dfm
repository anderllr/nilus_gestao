inherited FrmPesTituloPag: TFrmPesTituloPag
  Caption = 'Pesquisa Titulos a Pagar'
  ClientHeight = 474
  ClientWidth = 736
  Icon.Data = {
  ...
  inherited PanTopo: TCPanelGradient
    ...
    object PanRomaneio: TCPanelGradient
      ...
      object DBEidTituloPagIni: TCDBEdit
        Left = 59
        Top = 5
        Width = 70
        Height = 19
      ...
      object DBEidTituloPagFim: TCDBEdit
        Left = 157
        Top = 5
        Width = 70
        Height = 19
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object cdsPadraoidTituloPagIni: TStringField
      FieldName = 'idTituloPagIni'
    end
    object cdsPadraoidTituloPagFim: TStringField
      FieldName = 'idTituloPagFim'
    end
  ...
  inherited cdsGrid: TClientDataSet
    CommandText = 
      'SELECT tit.idTituloPag, tit.idEmpresa, tit.idCadEmpresa,tit.idFo' +
      'rnecedor, cad.descAbreviada, nrTituloPag, idDocSerie, dtEmissao,' +
      ' vlTituloPag, stTituloPag FROM TituloPag tit, vCadFornecedorCont' +
      'abil cad WHERE tit.idFornecedor = cad.idFornecedor'
    ...
    object cdsGridnrTituloPag: TStringField
      FieldName = 'nrTituloPag'
      Required = True
      FixedChar = True
    end
    ...
    object cdsGridvlTituloPag: TFMTBCDField
      FieldName = 'vlTituloPag'
      Required = True
      Precision = 10
      Size = 2
    end
    object cdsGridstTituloPag: TStringField
      FieldName = 'stTituloPag'
      Required = True
      FixedChar = True
      Size = 15
