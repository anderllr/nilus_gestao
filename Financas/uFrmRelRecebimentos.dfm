inherited FrmRelRecebimentos: TFrmRelRecebimentos
  Caption = 'Relat'#243'rio de Recebimentos realizados por Per'#237'odo'
  ClientHeight = 301
  ClientWidth = 893
  ExplicitWidth = 909
  ExplicitHeight = 340
  ...
  object DBEdtPagamentoFim: TCDBEdit [20]
    Left = 198
    Top = 189
    Width = 80
    Height = 19
  ...
  object DBEdtPagamentoIni: TCDBEdit [21]
    Left = 89
    Top = 189
    Width = 80
    Height = 19
  ...
  object DBCKincluirBcoCx: TCDBCheckBox [22]
    Left = 89
    Top = 214
    Width = 120
    Height = 17
    Caption = 'Incluir Caixa/Banco?'
    DataField = 'incluirBcoCx'
    DataSource = dsPadrao
    TabOrder = 17
    ValueChecked = 'S'
    ValueUnchecked = 'N'
  end
  object DBEidCliente: TCDBEdit [23]
    Left = 89
    Top = 39
    Width = 62
    Height = 19
  ...
  object LookCliente: TCLookUp [24]
    Left = 157
    Top = 39
    Width = 293
    Height = 19
  ...
  object DBEidResultado: TCDBEdit [25]
    Left = 89
    Top = 139
    Width = 62
    Height = 19
  ...
  object LookResultado: TCLookUp [26]
    Left = 157
    Top = 139
    Width = 293
    Height = 19
  ...
  object DBCKmostrarRateio: TCDBCheckBox [27]
    Left = 215
    Top = 214
    Width = 98
    Height = 17
    Caption = 'Mostrar Rateio?'
    DataField = 'mostrarRateio'
    DataSource = dsPadrao
    TabOrder = 18
    ValueChecked = 'S'
    ValueUnchecked = 'N'
  end
  object DBCKconsolidaemp: TCDBCheckBox [28]
    Left = 89
    Top = 237
    Width = 127
    Height = 17
  ...
  object DBCKconsolidafilial: TCDBCheckBox [29]
    Left = 215
    Top = 237
    Width = 98
    Height = 17
  ...
  object LookdescConta: TCLookUp [31]
    Left = 302
    Top = 89
    Width = 219
    Height = 19
  ...
  object LookContaCorrente: TCLookUp [32]
    Left = 202
    Top = 89
    Width = 94
    Height = 19
  ...
  object LookAgencia: TCLookUp [33]
    Left = 144
    Top = 89
    Width = 52
    Height = 19
  ...
  object DBCKagrupaCli: TCDBCheckBox [36]
    Left = 319
    Top = 214
    Width = 154
    Height = 17
  ...
  object DBCKagrupaLanc: TCDBCheckBox [37]
    Left = 319
    Top = 237
    Width = 154
    Height = 17
    Caption = 'Agrupar Lan'#231'amentos?'
    DataField = 'agrupaLanc'
    DataSource = dsPadrao
    TabOrder = 27
    ValueChecked = 'S'
    ValueUnchecked = 'N'
  end
  object DBEidGerencial: TCDBEdit [38]
    Left = 89
    Top = 164
    Width = 62
    Height = 19
  ...
  object LookGerenciaR: TCLookUp [39]
    Left = 157
    Top = 164
    Width = 293
    Height = 19
    ...
    AlternateSQL.Strings = (
        ...
        '= '#39'ATIVO'#39' AND tpGerencial = '#39'ENTRADAS'#39' AND idEmpresa = [DBEidEmp' +
        'resa] AND idGerencial = ?')
    ClientDataSet = cdsLookUp
    DataSource = dsPadrao
    ValidaCampoObrigatorio = True
    CampoObrigatorio = True
  ...
  object DBEidContratoVenda: TCDBEdit [40]
    Left = 355
    Top = 189
    Width = 95
    Height = 19
  ...
  inherited cdsRelatorio: TClientDataSet
    ...
    CommandText = 
      ' EXEC spRelRecebimentos 9999, 1, NULL, NULL, NULL, NULL, '#39'01/03/' +
      '2014'#39', '#39'30/03/2014'#39', NULL, '#39'S'#39', '#39'N'#39', '#39'N'#39', '#39'N'#39', '#39'N'#39
    Left = 784
    Top = 80
  end
  ...
  inherited cdsPadrao: TClientDataSet
    ...
    object cdsPadraoincluirBcoCx: TStringField
      FieldName = 'incluirBcoCx'
      Size = 1
    end
    object cdsPadraomostrarRateio: TStringField
      FieldName = 'mostrarRateio'
      Size = 1
    end
    ...
    object cdsPadraoagrupaCli: TStringField
      FieldName = 'agrupaCli'
      Size = 1
    end
    object cdsPadraoagrupaLanc: TStringField
      FieldName = 'agrupaLanc'
      Size = 1
    end
  ...
  object FrxRel: TfrxReport
    ...
    ReportOptions.LastChange = 42077.519594826390000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterResultado: TfrxMasterData
        FillType = ftBrush
        ...
        object Memo42: TfrxMemoView
          ...
          HideZeros = True
          Memo.UTF8W = (
            '[frxDataset."vlAcrescimoRat"]')
          ParentFont = False
          WordWrap = False
        end
        object Memo48: TfrxMemoView
          Left = 621.504330000000000000
          Width = 34.280337100000000000
          Height = 13.228346460000000000
          DataField = 'vlDescontoRat'
          DataSet = frxDataset
          DataSetName = 'frxDataset'
          DisplayFormat.DecimalSeparator = ','
          DisplayFormat.FormatStr = '%2.2n'
          ...
          HideZeros = True
          Memo.UTF8W = (
            '[frxDataset."vlDescontoRat"]')
          ParentFont = False
          WordWrap = False
        end
        object Memo16: TfrxMemoView
          Left = 396.850650000000000000
          Width = 155.225297100000000000
          Height = 13.228346460000000000
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object MDESC_RESULTADO: TfrxMemoView
        ...
        object MBANCOCAIXA: TfrxMemoView
        ...
        object MDESC_CAIXA: TfrxMemoView
          Left = 90.708632130000000000
          Top = 102.047310000000000000
          Width = 185.196970000000000000
          Height = 13.228346460000000000
        ...
        object MAGRUPALANC: TfrxMemoView
      ...
      object grpMovimento: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 
          'IntToStr(<frxDataset."idCliente">)+ '#39'-'#39' +<frxDataset."idDocSerie' +
          '"> + '#39'-'#39' + <frxDataset."nrTituloRec">+ '#39'-'#39' + IntToStr(<frxDatase' +
          't."idParcela">) + '#39'-'#39' + DateToStr(<frxDataset."dtRecebimento">) ' +
          '+ '#39'-'#39' + <frxDataset."descGerencial"> + '#39'-'#39' + FloatToStr(<frxData' +
          'set."vlRecebimento">)'
        KeepTogether = True
        object Memo14: TfrxMemoView
          Left = 149.354360000000000000
          Width = 34.264567100000000000
          Height = 13.228346460000000000
        ...
        object Memo30: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[frxDataset."nrTituloRec"]')
          ParentFont = False
          WordWrap = False
        end
        object Memo1: TfrxMemoView
          Left = 302.362400000000000000
          Width = 124.989057100000000000
          Height = 13.228346460000000000
      ...
      object grpPrincipal: TfrxGroupHeader
        FillType = ftBrush
        Height = 37.795300000000000000
        Top = 234.330860000000000000
        Width = 718.110700000000000000
        Condition = 'frxDataset."dtRecebimento"'
        ...
        object MTITFOR: TfrxMemoView
          Left = 1.511750000000000000
          Top = 20.409461020000000000
        ...
        object MTIT_GRUPO: TfrxMemoView
        ...
        object MDESC_GRUPO: TfrxMemoView
      ...
      object footPrincipal: TfrxGroupFooter
        FillType = ftBrush
        ...
        object MTIT_TOTAL: TfrxMemoView
        ...
        object MSOMA_TOTAL: TfrxMemoView
          Left = 646.299630000000000000
          Width = 68.296107100000000000
          Height = 13.228346460000000000
          DataSet = frxDataset
          DataSetName = 'frxDataset'
          DisplayFormat.DecimalSeparator = ','
          ...
          HideZeros = True
          Memo.UTF8W = (
            '[SUM(<frxDataset."vlRecebimento">,MasterResultado,1)]')
          ParentFont = False
          WordWrap = False
        end
      end
      object footMovimento: TfrxGroupFooter
        FillType = ftBrush
