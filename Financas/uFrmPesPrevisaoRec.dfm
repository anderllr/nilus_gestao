inherited FrmPesPrevisaoRec: TFrmPesPrevisaoRec
  Caption = 'Pesquisa Previsao a Receber'
  ClientHeight = 474
  ClientWidth = 736
  Icon.Data = {
  ...
  inherited cdsGrid: TClientDataSet
    CommandText = 
      'SELECT tit.idCliente, cad.descAbreviada, nrPrevisaoRec, idPrevis' +
      'aoRec, idDocSerie, dtEmissao, vlPrevisaoRec, stPrevisaoRec FROM ' +
      'Previsaorec tit, vCadClienteContabil cad WHERE tit.idCliente = c' +
      'ad.idCliente'
