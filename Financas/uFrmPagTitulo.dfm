inherited FrmPagTitulo: TFrmPagTitulo
  Caption = 'Pagamento de t'#237'tulos'
  ClientHeight = 662
  ClientWidth = 1113
  Icon.Data = {
  ...
  inherited PagAbas: TCPageControl
    ...
    object TabBanco: TTabSheet
      ...
      object CGroupBox4: TCGroupBox
        ...
        object cbEmitir: TcxCheckBox
          Left = 302
          Top = 7
          Caption = 'Emitir cheque ?'
          Enabled = False
          Properties.OnEditValueChanged = cbEmitirPropertiesEditValueChanged
          StyleDisabled.Color = 15201011
      ...
      object CGroupBox1: TCGroupBox
        ...
        object DBEidMovFinanceiraC: TCDBEdit
          ...
          DataSource = dsMovConta
          TabOrder = 8
          OnExit = DBEidMovFinanceiraCExit
  ...
  object CPanelGradient1: TCPanelGradient [8]
    ...
    object BtnCalcular: TCBitBtn
      Left = 657
      Top = 6
      Width = 136
      Height = 23
      Caption = 'Calcular Acr'#233'sc./Desc.'
      Glyph.Data = {
        36040000424D3604000000000000360000002800000010000000100000000100
  ...
  object CPanel1: TCPanel [10]
    ...
    object DBEsomavlPagoSelecao: TCDBEdit
      Left = 574
      Top = 4
      Width = 110
      Height = 19
  ...
  inherited imgIcones: TImageList
    ...
    Top = 24
    Bitmap = {
      494C010108000900480210001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object cdsGrid: TClientDataSet
    ...
    CommandText = 'SELECT * FROM tmpPagTitulo WHERE 1=2'
    Params = <>
    ...
    object cdsGridprMulta: TFMTBCDField
      FieldName = 'prMulta'
      Precision = 5
      Size = 3
    end
    object cdsGridprJuros: TFMTBCDField
      FieldName = 'prJuros'
      Precision = 5
      Size = 3
    end
    object cdsGridprDescontos: TFMTBCDField
      FieldName = 'prDescontos'
      Precision = 5
      Size = 3
    end
    ...
    object cdsGridsomavlPagoSelecao: TAggregateField
      FieldName = 'somavlPagoSelecao'
      Active = True
      currency = True
      DisplayName = ''
      Expression = 'SUM(vlPago*fator)'
    end
  end
  ...
  object Report: TfrxReport
    ...
    ReportOptions.LastChange = 41689.423194490700000000
  ...
  object cdsTmp: TClientDataSet
    ...
    Left = 896
    Top = 368
    object cdsTmpidTituloPag: TIntegerField
    ...
    object cdsTmpnrTituloPag: TStringField
    ...
    object cdsTmptpDocumento: TStringField
      FieldName = 'tpDocumento'
    end
    object cdsTmpdtEmissao: TSQLTimeStampField
      FieldName = 'dtEmissao'
      Required = True
    end
    object cdsTmpidSafra: TIntegerField
      FieldName = 'idSafra'
      Required = True
    end
    object cdsTmpidBanco: TIntegerField
      FieldName = 'idBanco'
    end
    object cdsTmpidIndice: TSmallintField
      FieldName = 'idIndice'
      Required = True
    end
    object cdsTmpidMovFinanceira: TIntegerField
      FieldName = 'idMovFinanceira'
      Required = True
    end
    object cdsTmpidResultado: TIntegerField
      FieldName = 'idResultado'
    end
    object cdsTmpidRateio: TSmallintField
      FieldName = 'idRateio'
    end
    object cdsTmpidGerencial: TIntegerField
      FieldName = 'idGerencial'
    end
    object cdsTmpobsTituloPag: TStringField
      FieldName = 'obsTituloPag'
      Size = 250
    end
    object cdsTmpvlTituloPag: TFMTBCDField
      FieldName = 'vlTituloPag'
      Required = True
      Precision = 10
      Size = 2
    end
    object cdsTmpqtParcelas: TSmallintField
      FieldName = 'qtParcelas'
      Required = True
    end
    object cdsTmpdtVencimentoIni: TSQLTimeStampField
      FieldName = 'dtVencimentoIni'
      Required = True
    end
    object cdsTmpdiasVencimento: TSmallintField
      FieldName = 'diasVencimento'
      Required = True
    end
    object cdsTmpprMulta: TFMTBCDField
      FieldName = 'prMulta'
      Required = True
      Precision = 5
      Size = 3
    end
    object cdsTmpprDesconto: TFMTBCDField
      FieldName = 'prDesconto'
      Required = True
      Precision = 5
      Size = 3
    end
    object cdsTmpprJuros: TFMTBCDField
      FieldName = 'prJuros'
      Required = True
      Precision = 5
      Size = 3
    end
    object cdsTmpincMes: TStringField
      FieldName = 'incMes'
      Required = True
      FixedChar = True
      Size = 1
    end
    object cdsTmpstTituloPag: TStringField
      FieldName = 'stTituloPag'
      Required = True
      Size = 15
    end
    object cdsTmpidCadEmpresa: TSmallintField
      FieldName = 'idCadEmpresa'
      Required = True
    end
    object cdsTmpidPortador: TSmallintField
      FieldName = 'idPortador'
    end
    object cdsTmpidConta: TSmallintField
      FieldName = 'idConta'
    end
    object cdsTmpidDocumento: TIntegerField
